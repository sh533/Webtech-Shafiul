        ...
        <ul>
          ...
          <li data-transition="random" data-slotamount="7" data-masterspeed="300"  data-saveperformance="off" > 
            ...
            <div class="tp-caption sfl tp-resizeme" 
                ...
                data-endspeed="300"
                style="z-index: 5; font-size:50px; font-weight:500; color:#fff;  max-width: auto; max-height: auto; white-space: nowrap;">Online Hospital Management System</div>
            ...
            <div class="tp-caption sfr tp-resizeme" 
                ...
                data-endspeed="300" 
                style="z-index: 6; font-size:40px; color:#fff; font-weight:500; white-space: nowrap;">We care about your health 
              </div>
            ...
            <div class="tp-caption lfb tp-resizeme scroll" 
                ...
                data-endspeed="300" 
                data-scrolloffset="0"
                style="z-index: 8;"><a href="#." class="btn">Book Now</a>
                 </div>
          </li>
          ...
          <li data-transition="random" data-slotamount="7" data-masterspeed="300"  data-saveperformance="off" > 
            ...
            <div class="tp-caption sfr tp-resizeme" 
                ...
                data-endelementdelay="0.4" 
                data-endspeed="300"
                style="z-index: 5; font-size:55px; font-weight:500; color:#000;  max-width: auto; max-height: auto; white-space: nowrap;">Online Hospital Management System</div>
          ...
          <li data-transition="random" data-slotamount="7" data-masterspeed="300"  data-saveperformance="off" > 
            ...
            <div class="tp-caption sfb tp-resizeme" 
                ...
                data-endspeed="300" 
                data-scrolloffset="0"
                style="z-index: 6; font-size:40px; color:#000; font-weight:500; white-space: nowrap;"> Welcome To Our Hospital </div>
      ...
      <div class="container">
        <div class="intro-main">
          <div class="row"> 
            ...
            <div class="col-md-8">
              <div class="text-sec">
                <h5>Health Check Up At Online Hospital Management System</h5>
                ...
                <ul class="row">
                  ...
                  <li class="col-sm-6">
                    ...
                    <p>ashjah ahsasj asasja asasj asbaj </p>
                  </li>
                  <li class="col-sm-6">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-offset-1 col-md-4">
                      <div class="doctor-img"> <img class="img-responsive" src="images/depart-doctor-img-1.jpg" alt="" >
                        <div class="name-doc">
                          <h6>Prof. Dr. Nurun nahar Khanam <span>Cardiology Specialists</span></h6>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-offset-1 col-md-4">
                      <div class="doctor-img"> <img class="img-responsive" src="images/depart-doctor-img-2.jpg" alt="" >
                        <div class="name-doc">
                          <h6>Asso. Prof. Dr. abul bashar<span>Cardiology Specialists</span></h6>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-offset-1 col-md-4">
                      <div class="doctor-img"> <img class="img-responsive" src="images/depart-doctor-img.jpg" alt="" >
                        <div class="name-doc">
                          <h6>Dr.Shohel Khan <span>Ophthalmology Specialists</span></h6>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="dep-sec-txt">
                  <div class="row">
                    ...
                    <div class="col-md-offset-1 col-md-4">
                      <div class="doctor-img"> <img class="img-responsive" src="images/depart-doctor-img.jpg" alt="" >
                        <div class="name-doc">
                          <h6> Dr.Shohel Khan<span>Emergency Specialists</span></h6>
                        </div>
                      </div>
                    </div>
                  </div>
